...
export const screens = [
  {
    ...
    data: [
      ...
      },
      {
        ...
        getScreen: () => require("./basic/BasicExamples").SectionListExampleScreen,
      },
      {
        name: "VirtualizedList",
        slug: "Basic/VirtualizedListExample",
        getScreen: () => require("./basic/BasicExamples").VirtualizedListExampleScreen,
      },
    ],
  },
  {
  ...
  },
  {
    ...
    data: [
      ...
      },
      {
        ...
        getScreen: () => require("./advanced/customGestureHandling/CustomGestureHandling").default,
      },
